...
abstract class $AuthUserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String userName, String email, String photo, int status});
}
...
class _$_AuthUser implements _AuthUser {
  ...
  @override
  String toString() {
    return 'AuthUser(id: $id, userName: $userName, email: $email, photo: $photo, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userName, email, photo, status);
...
abstract class _AuthUser implements AuthUser {
  factory _AuthUser(
      ...
      required final int status}) = _$_AuthUser;
